...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/karunakar/.vscode/extensions/wallabyjs.console-ninja-1.0.469/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20046623b0e24aad460e8dBRoHBgMdUApRVwcDAgcNVAFUWVwG', mode: 'build'}); } catch(cjsError) { try { import('file:///home/karunakar/.vscode/extensions/wallabyjs.console-ninja-1.0.469/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20046623b0e24aad460e8dBRoHBgMdUApRVwcDAgcNVAFUWVwG', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
